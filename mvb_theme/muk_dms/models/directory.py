...
class Directory(models.Model):
    ...
    is_root_directory = fields.Boolean(
        string="Là thư mục gốc",
        default=False,
        help="""Là thư mục gốc chứa toàn bộ các thư mục con có liên quan.""")
    ...
    #==========================================================
    # ThanhND add comment
    # Hàm dùng để sử dụng việc đánh dấu sao cho Directory
    #==========================================================
