...
class File(models.Model):
    ...
    # count_document = fields.Integer(string='Số lượng văn bản', compute='_count_document', readonly=True, store=True)
