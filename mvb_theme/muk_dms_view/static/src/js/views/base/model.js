...
var DocumentsModel = Class.extend(EventDispatcherMixin, ServicesMixin, {
    ...
    _loadFiles: function(operator, value, args) {
    	return this._rpc({
            ...
            fields: _.union(args.file.fields || [], [
            	'permission_read', 'permission_create', 
            	'permission_write', 'permission_unlink',
            	'name', 'mimetype', 'directory', 'size', 'count_document',
    ...
    _loadInitialData: function(args) {
        console.log('thanhnd: _loadInitialData')
    ...
    _loadNode: function(node, args) {
        console.log('thanhnd: _loadNode1')
        console.log('thanhnd: ' + node)
    	var result = $.Deferred();
    ...
    _makeNodeDirectory: function(directory, showFiles) {
        console.log('thanhnd:_makeNodeDirectory')
    	var directoryNode = {
    ...
    _makeNodeFile: function(file) {
        console.log('thanhnd:_makeNodeFile')
        console.log('thanhnd: '+ file.count_document)
        console.log('thanhnd: '+ file)
    	return {
			id: "file_" + file.id,
			text: file.name,
			...
			data: {
				...
				count_document: file.count_document,
