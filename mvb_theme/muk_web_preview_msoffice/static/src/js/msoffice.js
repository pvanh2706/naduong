...
var PreviewContentMSOffice = AbstractPreviewContent.extend({
    ...
    renderPreviewContent: function() {
		var viewer = 'https://docs.google.com/gview?embedded=true&url=';
		this.$('iframe').attr('src', viewer + encodeURIComponent(this.attachment.url ));
		console.log("renderPreviewContent file in msoffice", this.$('iframe'));
		console.log("renderPreviewContent file in msoffice", this.attachment.url);
		console.log("renderPreviewContent file in msoffice", this.url);
