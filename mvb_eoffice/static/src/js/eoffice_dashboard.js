...
//        'click .mvb_incoming_waiting':'mvb_incoming_waiting',
...
//
//code mơi
    mvb_incoming_waiting: function(e){
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
...
//            debugger;
            domain: [['check_work','=', false],['name', '=', this.login_employee.name]],
            target: 'current'
        },
        options)
    },
...
//            view_type: 'form',
//            views: [[false, 'list'],[false, 'form']],
////            domain: [['name','=', this.login_employee.id]],
//            target: 'current'
//        }, options)
//
//    },
